...
var ApplicationClient_1 = __importDefault(require("./clients/ApplicationClient"));
...
var TwitterClient = /** @class */ (function () {
    ...
    Object.defineProperty(TwitterClient.prototype, "application", {
        get: function () {
            if (!this.applicationClient) {
                this.applicationClient = new ApplicationClient_1.default(this.transport);
            }
